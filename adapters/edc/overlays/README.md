...
- **Dashboard UI:** the dashboard overlay adds the `Ontologies` menu entry, route, runtime `ontologyUrl` support, a read-only Ontology Hub browser, and a transfer-history pagination fallback used by the validation evidence flow.
