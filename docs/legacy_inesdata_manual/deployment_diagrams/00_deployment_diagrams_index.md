...
la documentación legacy.

No representan la arquitectura vigente del framework ni sustituyen la
documentación operativa actual. Para revisar el flujo actual usa:
...
- [3 Despliegue](./3_deployment.png)
- [4 Configurar conector](./4_configure_connector.png)
- [5 Crear espacio de datos](./5_create_dataspace.png)
- [6 Crear conector](./6_create_connector.png)
