...
adapter `edc`. El manual técnico conserva la descripción general del framework,
pero las comprobaciones de cierre de esta rama deben interpretarse en ese
alcance: conectores EDC distribuidos, servicios comunes, componentes y
validación asociada.

Para INESData en `vm-distributed`, la referencia correspondiente es
