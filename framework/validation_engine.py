...
class ValidationEngine:
    ...
    def build_newman_env(self, provider, consumer):
        ...
        return {
            ...
            "providerProtocolAddress": f"http://{provider}.{ds_domain}/protocol" if ds_domain else f"http://{provider}:19194/protocol",
            "consumerProtocolAddress": f"http://{consumer}.{ds_domain}/protocol" if ds_domain else f"http://{consumer}:19194/protocol",
