...
UI_CASE_METADATA: Dict[str, Dict[str, Any]] = {
    ...
    "PT5-MH-02": {
        ...
        "execution_mode": "ui",
        "coverage_status": "partial",
        "expected_result": "A provider can create a local model asset with valid metadata",
    ...
    "PT5-MH-07": {
        ...
        "execution_mode": "api_ui",
        "coverage_status": "partial",
        "expected_result": "The detailed model view exposes complete functional and technical metadata",
