...
- `validation/components/ontology_hub/runner.py`
- `validation/components/ontology_hub/ui/playwright.config.js`
- `validation/components/ontology_hub/ui/specs/*.spec.js`
...
```bash
cd validation/ui
./node_modules/.bin/playwright test --config=../components/ontology_hub/ui/playwright.config.js
```
...
La validacion de componentes se ejecuta desde `Level 6` sin tocar `validation/core`. En el caso de `ontology-hub`, el flujo integrado combina dos suites:

- `api`: runner tecnico de `validation/components/ontology_hub/runner.py`
- `ui`: suite Playwright de `validation/components/ontology_hub/ui/`
